...
def main():
    ...
    parser.add_argument(
        ...
        type=float,
        nargs="+",
        help="PBC cell vectors. If 9 floats, it corresponds to the sequence of the three cell vectors. If 6 floats, it corresponds to the lengths and angles (in rad) of the cell vectors. If 3 floats, it corresponds to the lengths of the cell vectors. If 1 float, it corresponds to the length of a cubic cell.",
    )
    parser.add_argument(
        "-c",
        "--nocomment",
    ...
    parser.add_argument(
        "--dxmax",
        type=float,
        help="Maximum displacement per step during optimization (default: 0.1 Angstroms)",
    )
